...
Our proprotion $\hat{p}$ follows a normal distribution with mean $p$ and standard deviation $\sqrt{p(1-p)/N} \approx \sqrt{0.45\times 0.55/1000} \approx 0.016$
...
Bute what if we didn't know? Or if we wanted a 99% confidence interval?
...
When the null hypotheis holds, $\sigma_{\hat{p}} = \sqrt{0.5\times 0.5 / 100} = 0.05$
...
* Suppose we have sample sizes of 25 and 100 for the the drug and placebo group repsectively and 
